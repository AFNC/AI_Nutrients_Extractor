...
### Demo
The user is prompted to upload a product label image. If the image contains a nutrition table, the system outputs the image showing the detected table within a red bounding box, along with the extracted text from the table in JSON format.
